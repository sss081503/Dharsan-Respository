...
#  Partner Name: Joseph Mikhail

#  Partner UT EID: jym436
...
class Sphere(object):
    ...
    def is_inside_cube(self, a_cube):
        ...
        point1 = Point(center_of_cube.x + (a_cube.side / 2), center_of_cube.y + (a_cube.side / 2),
                       center_of_cube.z + (a_cube.side / 2))
        point2 = Point(center_of_cube.x + (a_cube.side / 2), center_of_cube.y + (a_cube.side / 2),
                       center_of_cube.z - (a_cube.side / 2))
        point3 = Point(center_of_cube.x + (a_cube.side / 2), center_of_cube.y - (a_cube.side / 2),
                       center_of_cube.z + (a_cube.side / 2))
        point4 = Point(center_of_cube.x + (a_cube.side / 2), center_of_cube.y - (a_cube.side / 2),
                       center_of_cube.z - (a_cube.side / 2))
        point5 = Point(center_of_cube.x - (a_cube.side / 2), center_of_cube.y + (a_cube.side / 2),
                       center_of_cube.z + (a_cube.side / 2))
        point6 = Point(center_of_cube.x - (a_cube.side / 2), center_of_cube.y + (a_cube.side / 2),
                       center_of_cube.z - (a_cube.side / 2))
        point7 = Point(center_of_cube.x - (a_cube.side / 2), center_of_cube.y - (a_cube.side / 2),
                       center_of_cube.z + (a_cube.side / 2))
        point8 = Point(center_of_cube.x - (a_cube.side / 2), center_of_cube.y - (a_cube.side / 2),
                       center_of_cube.z - (a_cube.side / 2))

        if ((self.is_inside_point(point1) == True) and (self.is_inside_point(point2) == True) and (
                self.is_inside_point(point3) == True) and (self.is_inside_point(point4) == True)
                and (self.is_inside_point(point5) == True) and (self.is_inside_point(point6) == True) and (
                        self.is_inside_point(point7) == True) and (self.is_inside_point(point8) == True)):
            return True
        else:
            return False
    ...
    def is_inside_cyl(self, a_cyl):
        return self.center.distance(a_cyl.center) + a_cyl.radius < self.radius and (
                    abs(self.center.z - a_cyl.center.z) + a_cyl.height / 2.0) < self.radius
    ...
    def sphere_inside(self, c):
        return (self.center.distance(c.center) + c.radius) < self.radius
    ...
    def is_outside_cube(self, a_cube):
        ...
        if ((self.is_inside_point(point1) == False) and (self.is_inside_point(point2) == False) and (
                self.is_inside_point(point3) == False) and (self.is_inside_point(point4) == False)
                and (self.is_inside_point(point5) == False) and (self.is_inside_point(point6) == False) and (
                        self.is_inside_point(point7) == False) and (self.is_inside_point(point8) == False)):
            return True
        else:
            return False
    ...
    def circumscribe_cube(self):
        ...
        return Cube(self.center.x, self.center.y, self.center.z, cube_side)
...
class Cube(object):
    ...
    def is_inside_point(self, p):
        ...
        x_distance = abs(self.x - p.x)
        y_distance = abs(self.y - p.y)
        z_distance = abs(self.z - p.z)

        if (x_distance < (self.side / 2)) and (y_distance < (self.side / 2)) and (z_distance < (self.side / 2)):
            return True
        else:
            return False
    ...
    def is_inside_sphere(self, a_sphere):
        ...
        if self.is_inside_cube(new_cube):
            return True
        else:
            return False
    ...
    def is_inside_cube(self, other):
        point1 = Point(other.center.x + (other.side / 2), other.center.y + (other.side / 2),
                       other.center.z + (other.side / 2))
        point2 = Point(other.center.x + (other.side / 2), other.center.y + (other.side / 2),
                       other.center.z - (other.side / 2))
        point3 = Point(other.center.x + (other.side / 2), other.center.y - (other.side / 2),
                       other.center.z + (other.side / 2))
        point4 = Point(other.center.x + (other.side / 2), other.center.y - (other.side / 2),
                       other.center.z - (other.side / 2))
        point5 = Point(other.center.x - (other.side / 2), other.center.y + (other.side / 2),
                       other.center.z + (other.side / 2))
        point6 = Point(other.center.x - (other.side / 2), other.center.y + (other.side / 2),
                       other.center.z - (other.side / 2))
        point7 = Point(other.center.x - (other.side / 2), other.center.y - (other.side / 2),
                       other.center.z + (other.side / 2))
        point8 = Point(other.center.x - (other.side / 2), other.center.y - (other.side / 2),
                       other.center.z - (other.side / 2))
...
class Cylinder(object):
    ...
    # returns a Boolean
    def is_inside_point(self, p):
        if (abs(self.center.z - p.z) < self.height / 2) and (
    ...
    def is_inside_sphere(self, a_sphere):
        ...
        if valid1 and (a_sphere.center.z < self.center.z + (self.height / 2) - a_sphere.radius) and (
                a_sphere.center.z > self.center.z - self.height + a_sphere.radius):
            return True
        else:
            return False
